 ...
 */
final class Version20231106132846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE passage_certification (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', stagiaire_id_id INT NOT NULL, certification_id_id INT NOT NULL, obtention_certification VARCHAR(255) NOT NULL, donnee_certifiee TINYINT(1) NOT NULL, date_debut_validite DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_fin_validite DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', presence_niveau_langue_euro TINYINT(1) NOT NULL, presence_niveau_numerique_euro TINYINT(1) NOT NULL, scoring VARCHAR(255) DEFAULT NULL, mention_validee VARCHAR(255) DEFAULT NULL, INDEX IDX_88495CEB2AA7DFFB (stagiaire_id_id), INDEX IDX_88495CEB34012818 (certification_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
